...
export default function CartStep({ cart, updateQuantity, removeItem, clearCart, onNext }: CartStepProps) {
  return (
      ...
      {cart.length === 0 ? (
        ...
        <>
          ...
          <div className="mt-8 flex flex-col sm:flex-row sm:justify-between gap-4">
            ...
            <button
              className="bg-black text-white px-7 py-2 font-semibold hover:bg-gray-800 cursor-pointer"
              onClick={onNext}
            >
              Next: Delivery
            </button>
