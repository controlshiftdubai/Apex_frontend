        ...
        <div className="mx-auto max-w-screen-2xl h-[72px] md:h-[84px] px-3 sm:px-4 lg:px-6">
            ...
            <div className="ml-6 flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="ml-2 grid grid-cols-3 gap-3">
                ...
                >
                  ...
                  <Badge count={0} />
                  <span className="pointer-events-none absolute left-2 right-2 bottom-1 h-0.5 origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-200" style={{ background: "var(--underline-color)" }} aria-hidden="true" />
                </Button>
          ...
          <div className="md:hidden flex items-center h-full">
            <Link href="/" className="rounded-md block shrink-0 cursor-pointer">
              <Image src="/logo.png" alt="logo" width={140} height={34} sizes="140px" className="block h-9 w-auto" priority />
            </Link>
