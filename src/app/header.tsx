      ...
      >
        <div className="max-w-none px-4 mx-auto h-full">
          <div className="flex justify-between items-center h-full">
           ...
           <Link
  href="/"
  className="transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg rounded-md"
>
  <Image
    src="/logo.png"
    alt="3d logo"
  ...
  className={`h-12 w-12 text-gray-800 hover:bg-gray-100 transition-all duration-500
    ...
    ${mounted ? "opacity-100 scale-100 delay-200" : "opacity-0 scale-75"}
  `}
>
  {openMenuMobile ? (
